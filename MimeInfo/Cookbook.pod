...
In fact most other IO:: will work as long as they support the C<seek()>
...
Regrettably using an IO won't work on non-seekable filehandles like
STDIN. You will need to buffer enough of these files for a proper
...
=item Force the use of a certain database directory
